    ...
    const result = convert([
      {
        ...
        warnings: [{ line: 42, text: 'This is a linting error', rule: 'linting-error', severity: 'error' }]
      }
    ])
    ...
    const result = convert([
      {
        ...
        warnings: [
          ...
          { line: 44, text: 'This is another linting error', rule: 'other-linting-error', severity: 'warning' }
        ]
      }
    ])
    expect(result).toStrictEqual([
